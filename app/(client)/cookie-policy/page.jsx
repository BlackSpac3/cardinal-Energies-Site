...
export const metadata = {
  title: "Cookie Policy",
  openGraph: {
    url: "https://www.cardinaltorch.com/cookie-policy",
    type: "website",
    images: [
      {
...
const page = () => {
  return (
    <section className="my-[40px] flex flex-col gap-5 max-w-[1024px] p-5 mx-auto blog-content body-text !font-normal">
      <div>
        <h1 className="text-center text-black">Cookie Policy</h1>
        <p className="body-text !font-bold mt-1">
          Last updated November 27, 2024
        </p>
      </div>

      <p>
        This Cookie Policy explains how Cardinal Torch Company Limited (
      ...
      <h3 className="text-black">What are cookies?</h3>
      <p>
      ...
      <p>
        Cookies set by the website owner (in this case, Cardinal Torch Company
        Limited) are called "first-party cookies." Cookies set by parties other
      ...
      <h3 className="text-black">Why do we use cookies?</h3>
      <p>
      ...
      <h3 className="text-black">How can I control cookies?</h3>
      <p>
      ...
      <h3 className="text-black">How can I control cookies on my browser?</h3>
      <p>
      ...
      <h3 className="text-black">Do you serve targeted advertising?</h3>
      <p>
      ...
      <h3 className="text-black">Where can I get further information?</h3>
      <p>
        If you have any questions about our use of cookies or other
        technologies, please contact us at:
      </p>
      <p>
        Cardinal Torch Company Limited <br /> 19b Sinari Daranijo St, Victoria
        Island, Lagos 106104, <br /> Lagos Lagos, Lagos 106104 <br /> Nigeria{" "}
        <br /> Phone: +2349040244446
      </p>
    </section>
  );
};

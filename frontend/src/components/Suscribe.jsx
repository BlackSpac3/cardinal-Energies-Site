...
const Suscribe = () => {
  return (
    <section className="relative bg-primary text-white  h-[25vw] flex justify-end phone:flex phone:flex-col phone:items-center phone:h-[60vh] phone:static phone:m-body phone:rounded-3xl">
      <div className="phone:hidden bg-newsletter-subscribe bg-cover w-full h-full absolute phone:static phone:h-[40%] phone:bg-center"></div>
      <img
      ...
      <div
        ...
        className="w-[40%] phone:w-[80%] tab-m:w-[50%] tab-m:mr-[3vw] my-auto phone:mr-0 mr-[7vw]"
      >
        ...
        <div className="bg-white w-[90%] phone:w-full tab:text-sm text-black rounded-full p-1">
          <div className="grid grid-cols-2 items-center">
            ...
            <div className="place-self-end">
              <button className="bg-black tab:text-sm text-white tab-m:px-5 tab-m:py-2 px-10 rounded-3xl py-3">
                Suscribe
              </button>
            </div>
          </div>

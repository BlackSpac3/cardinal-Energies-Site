  ...
  return (
    ...
    >
      <footer className="flex flex-col bg-[#4f8c66] px-[10vw] phone:px-[7vw] pb-10 pt-14 text-white gap-10 w-full items-center z-0 text-sm">
        ...
        <div className="flex justify-between items-center w-full text-gray-100 text-xs phone:flex-col-reverse phone:gap-5 mb-2">
          <p id="footer-copyright" className="tab-m:text-center">
            &copy; {new Date().getFullYear()} Cardinal Torch Company Limited -
            All Right Reserved.
          </p>

...
const GalleryModal = ({ id, images, currentIndex, setCurrentIndex }) => {
  const curImageData = () => {
    ...
    try {
      ...
      profile_image_src = `${url}/profile-images/${images.results[currentIndex].author.personal_info.profile_img}uploads/${images.results[currentIndex].author.personal_info.profile_img}`;

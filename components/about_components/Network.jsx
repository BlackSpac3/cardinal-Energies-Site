        ...
        >
          <div className=" grid grid-cols-2 phone:grid-cols-1  gap-5 tab:mt-12 ">
            <div className="w-full flex flex-col gap-2">
              <h3 className="text-1xl text-primary">FARMERS</h3>
              <p className="body-text">
            ...
            <div className="w-full flex flex-col gap-2">
              <h3 className="text-1xl text-primary ">LOCAL COMMUNITIES</h3>
              <p className="body-text">
            ...
            <div className=" w-full flex flex-col gap-2">
              <h3 className=" text-1xl text-primary ">INVESTORS</h3>
              <p className="body-text">

...
const WhatWeDo = () => {
  return (
    <section className="relative px-[7vw] tab-s:px-0 ">
      <div className="text-center">
        <h2 className="small-section-title text-primary">What We Do</h2>
      </div>
      <div className="grid grid-cols-2 gap-5 tab:grid-cols-1">
        ...
        >
          ...
          <p className="body-text">
            From raw cocoa beans to finished cashew products, we are able to
            deliver our goods to customers around the world in a timely and
